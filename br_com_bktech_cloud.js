...
document.getElementById('skin_container_refresh').insertAdjacentHTML('beforebegin',"<div title=\"Abrir Site\" onclick=\"window.open('https://nuvem.bktech.com.br/')\" style=\"float:left; background-image:url('"+zimletInstance.getResource('cloud-computing.png')+"');background-repeat:no-repeat;height:16px;width:16px;cursor:pointer\"></div>");  
} catch(err)
{
